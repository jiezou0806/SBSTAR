...
public class SeqBayesSearch_Main {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			String stopDic = "0.65";//stop point
				...
				String doc_qrel_relePath = "/clef/abs_qrels/" + topicname + stopDic + ".txt";//the missing relevant documents ID for each topic and each stop point
				String countAlpha = "/clef/X_LR/" + stopDic + "/"+ topicname + "LRresult.txt";//the initial \alpha of the prior belief P_0 when stopping BMI.
